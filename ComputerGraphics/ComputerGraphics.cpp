// ComputerGraphics.cpp : 定义应用程序的入口点。
//
	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_COMPUTERGRAPHICS, szWindowClass, MAX_LOADSTRING);
	...
	{
		BOOL isGot = PeekMessage(&msg, NULL, 0, 0, PM_REMOVE);
		if (isGot)
		{
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	//case MK_LBUTTON:
	//	if(gamePlay)
	//		gamePlay->isActive = !gamePlay->isActive;
	//	break;
	case WM_SIZE:
		gamePlay->Refresh();
